...
export const projectContent = {
  ...
  systemLoop: ['宠物', '可穿戴设备', '数据 / 解释', 'PetLoop 控制台', '主人', '桌面机器人', '宠物'],
  dataPipeline: [
    { step: '01', title: '量化行为', text: '通过声音、视频/行为观察与 MPU6050 等运动信息，将宠物行为转为可处理的数据线索。' },
    { step: '02', title: '特征提取', text: '声音侧以 MFCC 等特征思路、运动侧以加速度与行为特征进行整理，形成可用于分析的输入。' },
    { step: '03', title: '理解解释', text: '原项目提出 AI 情绪分类与机器学习行为分类的处理路径；网站不声明未经材料证明的准确率或临床能力。' },
  ],
  wearable: {
    eyebrow: '可穿戴 / 01',
    title: '倾听宠物无法言说的需求',
  ...
  media: {
    ...
    wearable: { src: 'assets/wearable/wearable-process.webp', alt: '宠物可穿戴设备草图、材料测试与穿戴原型制作过程', sourceNote: '课程汇报产品制作页，压缩用于 可穿戴设备 章节。' },
    robot: { src: 'assets/robot/robot-build.webp', alt: 'PetLoop 桌面机器人零件与搭建过程', sourceNote: '课程汇报机器狗搭建过程页，压缩用于 Robot 章节。' },
    ui: { src: 'assets/ui/ui-suite.webp', alt: 'PetLoop 控制台 与多端产品界面设计', sourceNote: '求职精简版 PetLoop GUI 展示页，压缩用于 Product Experience。' },
